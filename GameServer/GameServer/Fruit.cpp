...
bool CFruit::UseFruitAddPoint(LPOBJ lpObj,int type) // OK
{
	...
	if((rand()%100) < ((gServerInfo.m_FruitAddPointSuccessRate[lpObj->AccountLevel]==-1)?rate:gServerInfo.m_FruitAddPointSuccessRate[lpObj->AccountLevel]))
	{
		int amount = gServerInfo.m_FruitAddPointMin+(rand()%((gServerInfo.m_FruitAddPointMax-gServerInfo.m_FruitAddPointMin)+1));
...
bool CFruit::UseFruitSubPoint(LPOBJ lpObj,int type) // OK
{
	...
	if((rand()%100) < ((gServerInfo.m_FruitSubPointSuccessRate[lpObj->AccountLevel]==-1)?rate:gServerInfo.m_FruitSubPointSuccessRate[lpObj->AccountLevel]))
	{
		int amount = gServerInfo.m_FruitSubPointMin+(rand()%((gServerInfo.m_FruitSubPointMax-gServerInfo.m_FruitSubPointMin)+1));

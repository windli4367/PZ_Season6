...
bool CSkillManager::SkillMonsterSummon(int aIndex,int bIndex,CSkill* lpSkill) // OK
{
	...
	{
		case 161:
			MonsterClass = 147+rand()%2;
			break;
		case 181:
			MonsterClass = 177+rand()%2;
	 		break;
		case 189:
			MonsterClass = 185+rand()%2;
			break;
		case 197:
			MonsterClass = 193+rand()%2;
			break;
		case 267:
			MonsterClass = 263+rand()%2;
			break;
		case 275:
			MonsterClass = 271+rand()%2;
			break;
		default:
			return 0;
	}
...
bool CSkillManager::SkillOrderOfTracking(int aIndex,int bIndex) // OK
{
	...
	for(int n=0;n < 50;n++)
	{
		int tx = gObj[bIndex].X+((rand()%3)-1);
		int ty = gObj[bIndex].Y+((rand()%3)-1);
...
bool CSkillManager::SkillBlind(int aIndex,int bIndex,CSkill* lpSkill) // OK
{
	...
	if(lpSkill->m_index == MASTER_SKILL_ADD_BLIND_IMPROVED && (rand()%100) < gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_BLIND_IMPROVED))
	{
...
void CSkillManager::ApplyMeteoriteEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < (gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_METEORITE_ENHANCED)-lpTarget->ResistStunRate))
	{
...
void CSkillManager::ApplyIceStormEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_ICE_STORM_ENHANCED))
	{
...
void CSkillManager::ApplyTwistingSlashEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_TWISTING_SLASH_ENHANCED))
	{
...
void CSkillManager::ApplyRagefulBlowEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_RAGEFUL_BLOW_ENHANCED))
	{
		if(lpObj->Type == OBJECT_USER && lpTarget->Type == OBJECT_USER)
		{
			CItem* lpItem = &lpTarget->Inventory[(damage=(2+(rand()%5)))];
...
void CSkillManager::ApplyDeathStabEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < (gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_DEATH_STAB_MASTERED)-lpTarget->ResistStunRate))
	{
		gEffectManager.AddEffect(lpTarget,0,EFFECT_STERN,2,0,0,0,0);
	}
	else if((rand()%100) < gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_DEATH_STAB_ENHANCED))
	{
...
void CSkillManager::ApplyFireBurstEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < (gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_FIRE_BURST_ENHANCED)-lpTarget->ResistStunRate))
	{
		gEffectManager.AddEffect(lpTarget,0,EFFECT_STERN,2,0,0,0,0);
	}
...
void CSkillManager::ApplyEarthquakeEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < (gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_EARTHQUAKE_ENHANCED)-lpTarget->ResistStunRate))
	{
		gEffectManager.AddEffect(lpTarget,0,EFFECT_STERN,2,0,0,0,0);
	}
	else
...
void CSkillManager::ApplyNeilEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < (gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_NEIL_ENHANCED)-lpTarget->ResistStunRate))
	{
		gEffectManager.AddEffect(lpTarget,0,EFFECT_STERN,2,0,0,0,0);
	}
...
void CSkillManager::ApplyGhostPhantomEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_GHOST_PHANTOM_ENHANCED))
	{
		gObjAddMsgSendDelay(lpTarget,2,lpObj->Index,150,0);
	}
	else
...
void CSkillManager::ApplyFrozenStabEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_FROZEN_STAB_MASTERED))
	{
		gEffectManager.AddEffect(lpTarget,0,EFFECT_FROZEN_STAB_MASTERED,5,0,0,0,0);
	}
	else if((rand()%100) < gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_FROZEN_STAB_ENHANCED))
	{
...
void CSkillManager::ApplyFiveShotEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < (gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_FIVE_SHOT_ENHANCED)-lpTarget->ResistStunRate))
	{
		gEffectManager.AddEffect(lpTarget,0,EFFECT_STERN,3,0,0,0,0);
	}
...
void CSkillManager::ApplyLargeRingBlowerEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < (5+gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_LARGE_RING_BLOWER_ENHANCED)))
	{
...
void CSkillManager::ApplyUpperBeastEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < (5+gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_UPPER_BEAST_ENHANCED)))
	{
...
void CSkillManager::ApplyChainDriverEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_CHAIN_DRIVER_ENHANCED))
	{
		damage = 100;
...
void CSkillManager::ApplyDragonLoreEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_DRAGON_LORE_ENHANCED))
	{
		damage = 100;
...
void CSkillManager::ApplyDragonSlayerEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < (gMasterSkillTree.GetMasterSkillValue(lpObj,MASTER_SKILL_ADD_DRAGON_SLAYER_ENHANCED)-lpTarget->ResistStunRate))
	{
		gEffectManager.AddEffect(lpTarget,0,EFFECT_STERN,2,0,0,0,0);
	}
...
void CSkillManager::ApplyEarthPrisonEffect(LPOBJ lpObj,LPOBJ lpTarget,CSkill* lpSkill,int damage) // OK
{
	...
	if((rand()%100) < gServerInfo.m_EarthPrisonConstA)
	{

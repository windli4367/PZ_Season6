...
void CChaosBox::Wing2Mix(LPOBJ lpObj,int type) // OK
{
	...
	if((rand()%100) < lpObj->ChaosSuccessRate)
	{
		if(type == 0)
		{
			...
			GDCreateItemSend(lpObj->Index,0xFF,0,0,ItemIndex,0,0,0,ItemOption2,ItemOption3,-1,(ItemNewOption+(32*(rand()%2))),0,0,0,0,0xFF,0);
...
void CChaosBox::Wing3Mix(LPOBJ lpObj) // OK
{
	...
	if((rand()%100) < lpObj->ChaosSuccessRate)
	{
		...
		GDCreateItemSend(lpObj->Index,0xFF,0,0,ItemIndex,0,0,0,ItemOption2,ItemOption3,-1,(ItemNewOption+(16*(rand()%3))),0,0,0,0,0xFF,0);
...
void CChaosBox::SocketItemCreateSeedMix(LPOBJ lpObj) // OK
{
	...
	if((rand()%100) < lpObj->ChaosSuccessRate)
	{
		int SocketOptionType = 1+(rand()%MAX_SOCKET_ITEM_OPTION_TYPE);

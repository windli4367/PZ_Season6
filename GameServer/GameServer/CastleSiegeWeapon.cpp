...
void CCastleSiegeWeapon::GetTargetPointXY(int type,int PointIndex,BYTE* ox,BYTE* oy) // OK
{
	...
	if(type == 0)
	{
		(*ox) = gCastleSiegeWeaponOffenseZone[PointIndex][0]+(rand()%(gCastleSiegeWeaponOffenseZone[PointIndex][2]-gCastleSiegeWeaponOffenseZone[PointIndex][0]));
		(*oy) = gCastleSiegeWeaponOffenseZone[PointIndex][1]+(rand()%(gCastleSiegeWeaponOffenseZone[PointIndex][3]-gCastleSiegeWeaponOffenseZone[PointIndex][1]));
	}

	if(type == 1)
	{
		(*ox) = gCastleSiegeWeaponDefenseZone[PointIndex][0]+(rand()%(gCastleSiegeWeaponDefenseZone[PointIndex][2]-gCastleSiegeWeaponDefenseZone[PointIndex][0]));
		(*oy) = gCastleSiegeWeaponDefenseZone[PointIndex][1]+(rand()%(gCastleSiegeWeaponDefenseZone[PointIndex][3]-gCastleSiegeWeaponDefenseZone[PointIndex][1]));
	}
}

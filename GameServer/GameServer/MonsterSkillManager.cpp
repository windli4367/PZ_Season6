...
CMonsterSkillUnitInfo* CMonsterSkillManager::FindMonsterSkillUnitInfo(int aIndex,int MonsterSkillUnitType) // OK
{
	...
	return ((MonsterSkillUnitTypeCount==0)?0:CMonsterSkillManager::m_MonsterSkillInfoArray[lpObj->Class].m_SkillUnitArray[MonsterSkillUnitTypeTable[rand()%MonsterSkillUnitTypeCount]]);
}
